...
SS_solve= function(data,burnin_iter_vec_thin,iter_vec_thin,MCMCstart){
  ...
  return(list(edge_vec=edge_vec,time_vec=time_vec,iter_vec_thin=iter_vec_thin,burnin_iter_vec_thin=burnin_iter_vec_thin,plinks=plinks_new,plinks_iter_matrix=plinks_iter_matrix))
}
...
MCMCstart = "empty"
if (algorithm == "SS"){
    burnin_iter_vec_thin = c(50,100)
    iter_vec_thin = c(1,5,10,50,100,250,500,750,1000,1500,2000,2500,3000,3500,4000,4500,5000)
    output = SS_solve(data=data,burnin_iter_vec_thin=burnin_iter_vec_thin,iter_vec_thin=iter_vec_thin,MCMCstart=MCMCstart)
}
if (algorithm == "BDA"){
    burnin_iter_vec_thin = c(10000,25000)
    iter_vec_thin = c(10,100,500,1000,5000,10000,25000,50000,100000,150000,200000,250000,300000,350000,400000,450000,500000,550000,600000,650000,700000,750000)
